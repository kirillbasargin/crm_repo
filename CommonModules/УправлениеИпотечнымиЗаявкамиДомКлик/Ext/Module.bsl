...
Функция СозданиеДокументов(ПараметрыAPI, ID_Анкеты, Документ, ТипДокумента, ПодтипДокумента = Неопределено, Ошибки = "", Тест = Ложь) Экспорт
	...
	ДвоичныеДанные = ПоместитьБанарныеДанныеВТелоЗапроса(Документ, Boundary, СтрЗаменить(ID_Тип, Символы.НПП, ""), СтрЗаменить(ID_Подтип, Символы.НПП, ""), Ошибки);	
...
Функция ПоместитьБанарныеДанныеВТелоЗапроса(ПрикрепляемыйФайл, Boundary, ТипДокумента, ПодтипДокумента = Неопределено, Ошибки = "") 
